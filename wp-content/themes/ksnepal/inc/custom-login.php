<?php
/**
 * ksnepal Theme Login/Signup Form
 *
 * @package ksnepal
 */
...
function ksnepal_enqueue_login_register(){
	$h = '(function($){';
	$h .= "try{";
	...
	$h .= '})(jQuery);';
	wp_enqueue_script( 'ksnepal-validation', get_template_directory_uri() . '/js/jquery.validate.js', array('jquery'), '', true );
	wp_add_inline_script('ksnepal-validation',$h);
}
add_action('wp_enqueue_scripts','ksnepal_enqueue_login_register');