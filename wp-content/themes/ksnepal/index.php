...
<section class="inner-banner__alt inner-banner news-part banner bg-cover">
    <img src="<?php echo get_field('ks_background_image', $page_for_posts) ? get_field('ks_background_image', $page_for_posts)['url'] : get_site_url() . '/media/knowledge-base-wordpress-theme-header.jpeg' ?>"
        alt="<?php echo get_field('ks_background_image', $page_for_posts) ? get_field('ks_background_image', $page_for_posts)['alt'] : 'news-page-banner' ?>">
    <div class="inner-banner__altcontent">
        <div class="container">
            <div class="text-center">
                <h1><?php echo get_field('ks_nepali_title', $page_for_posts) ?></h1>
