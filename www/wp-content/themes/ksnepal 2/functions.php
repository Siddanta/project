...
if (!function_exists('ksnepal_setup')) :
	...
	function ksnepal_setup()
	{
		...
		register_nav_menus(array(
			'menu-1' => esc_html__('Primary', 'ksnepal'),
		));
...
function ksnepal_scripts()
{
	...
	wp_enqueue_script('ksnepal-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true);

	wp_enqueue_script('ksnepal-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true);
